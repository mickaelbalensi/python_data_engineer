...
# # Define the S3 path where your CSV file is stored
# s3_input_path = "s3://spotify-streaming-data/streams1.csv"

# # Log information about the start of the ETL job
# logger.info(f"Starting ETL job to read data from {s3_input_path}")

# # Load the CSV file into a DynamicFrame from S3
# datasource0 = glueContext.create_dynamic_frame.from_options(
#     connection_type="s3",
#     connection_options={"paths": [s3_input_path]},
#     format="csv",  # Specify the format as CSV
#     format_options={"withHeader": True, "separator": ","}  # Customize if necessary
# )

# # Log the schema of the DynamicFrame
# logger.info("Schema of the loaded data:")
# datasource0.printSchema()
# logger.info(f"First 5 rows of the loaded data:{datasource0.head(5)}")
# # If you need to write the transformed data back to S3:
# s3_output_path = "s3://spotify-streaming-data/output/"
# logger.info(f"Writing transformed data to {s3_output_path}")
